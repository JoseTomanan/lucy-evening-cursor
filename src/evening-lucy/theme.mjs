export default ({ name, colors }) => ({
  ...
  colors: {
    ...
    'editor.selectionHighlightBackground': colors.highlightBg,
    ...
    'editor.wordHighlightStrongBackground': colors.wordHighlight,
    ...
    'editorInfo.foreground': colors.diagInfo,
    'editorInfo.border': colors.translucent8,
    'editorHint.foreground': colors.diagHint,
    ...
    'statusBarItem.warningBackground': colors.statusWarning,
    'statusBarItem.errorBackground': colors.statusError,
    ...
    // Minimap highlights
    'minimap.findHighlight': colors.minimapFind,
    ...
    'editorBracketHighlight.foreground4': colors.bracket4,
    'editorBracketHighlight.foreground5': colors.bracket5,
    'editorBracketHighlight.foreground6': colors.bracket6,
    'editorBracketPairGuide.activeBackground1': colors.bracket1,
    'editorBracketPairGuide.activeBackground2': colors.bracket2,
    'editorBracketPairGuide.activeBackground3': colors.bracket3,
    'editorBracketPairGuide.activeBackground4': colors.bracket4,
    'editorBracketPairGuide.activeBackground5': colors.bracket5,
    'editorBracketPairGuide.activeBackground6': colors.bracket6
  },
  tokenColors: [
    {
      scope: [
